  ...
  return (
    <div className="fixed bottom-6 left-1/2 -translate-x-1/2 z-[990] w-full max-w-sm px-4 pb-[env(safe-area-inset-bottom)]">
      <div className="bg-white/80 backdrop-blur-xl border border-white/60 shadow-2xl shadow-green-900/10 rounded-3xl p-2 flex gap-2 w-full transition-all">
        <button 
          onClick={onGPS}
          className="flex-1 flex flex-col items-center justify-center gap-1 py-3 px-2 rounded-2xl text-[#0000fe] hover:bg-white/80 transition-all font-medium group relative overflow-hidden"
        >
        ...
        <button 
          onClick={onAdd}
          className="flex-[1.5] flex items-center justify-center gap-2 bg-[#0000fe] text-white py-3 px-6 rounded-2xl hover:bg-[#0000d0] transition-all font-bold shadow-lg shadow-[#0000fe]/30 hover:shadow-[#0000fe]/50 hover:-translate-y-0.5"
        >
